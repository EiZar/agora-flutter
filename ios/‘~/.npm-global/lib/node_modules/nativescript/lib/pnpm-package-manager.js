...
class PnpmPackageManager extends base_package_manager_1.BasePackageManager {
    ...
    view(packageName, config) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let viewResult;
            try {
                viewResult = yield this.$childProcess.exec(`pnpm info ${packageName} ${flags}`);
            }
            catch (e) {
    ...
    getRegistryPackageData(packageName) {
        return __awaiter(this, void 0, void 0, function* () {
            const registry = yield this.$childProcess.exec(`pnpm config get registry`);
    ...
    getCachePath() {
        return __awaiter(this, void 0, void 0, function* () {
            const cachePath = yield this.$childProcess.exec(`pnpm config get cache`);
            return path.join(cachePath.trim(), constants_1.CACACHE_DIRECTORY_NAME);
        });
    }
}
__decorate([
    decorators_1.exported("pnpm")
], PnpmPackageManager.prototype, "install", null);
__decorate([
    decorators_1.exported("pnpm")
], PnpmPackageManager.prototype, "uninstall", null);
__decorate([
    decorators_1.exported("pnpm")
], PnpmPackageManager.prototype, "view", null);
__decorate([
    decorators_1.exported("pnpm")
], PnpmPackageManager.prototype, "search", null);
__decorate([
    decorators_1.exported("pnpm")
], PnpmPackageManager.prototype, "getRegistryPackageData", null);
__decorate([
    decorators_1.exported("pnpm")
