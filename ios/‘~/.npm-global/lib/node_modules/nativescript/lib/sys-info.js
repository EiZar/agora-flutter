...
class SysInfo {
    ...
    getSysInfo(config) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.sysInfo) {
                const pathToNativeScriptCliPackageJson = (config && config.pathToNativeScriptCliPackageJson) ||
                    path.join(__dirname, "..", "package.json");
                const androidToolsInfo = config && config.androidToolsInfo;
                this.sysInfo = yield doctor_1.sysInfo.getSysInfo({
    ...
    getXcodeVersion() {
        return doctor_1.sysInfo.getXcodeVersion();
    }
    getCocoaPodsVersion() {
        return doctor_1.sysInfo.getCocoaPodsVersion();
    }
    getJavaPath() {
        return doctor_1.sysInfo.getJavaPath();
    }
    getJavaCompilerVersion() {
        return doctor_1.sysInfo.getJavaCompilerVersion();
    }
    getJavaVersionFromPath() {
        return doctor_1.sysInfo.getJavaVersionFromPath();
    }
    getJavaVersionFromJavaHome() {
        return doctor_1.sysInfo.getJavaVersionFromJavaHome();
    }
    getSystemWarnings() {
        return __awaiter(this, void 0, void 0, function* () {
            const warnings = [];
