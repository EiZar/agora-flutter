    ...
    deploy(platform, additionalOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const deviceDescriptors = devices.map((d) => {
                ...
                const buildData = this.$buildDataService.getBuildData(this.$projectData.projectDir, d.deviceInfo.platform, Object.assign(Object.assign({}, this.$options.argv), { outputPath, buildForDevice: !d.isEmulator, skipWatcher: !this.$options.watch, nativePrepare: {
