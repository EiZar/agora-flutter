    ...
    createLocalToDevicePaths(deviceAppData, projectFilesPath, files, excludedProjectDirsAndFiles, projectFilesConfig) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localToDevicePaths = Promise.all(files
                ...
                .map((projectFileInfo) => __awaiter(this, void 0, void 0, function* () {
                return this.$localToDevicePathDataFactory.create(projectFileInfo.filePath, projectFilesPath, projectFileInfo.onDeviceFileName, deviceProjectRootPath);
            })));
