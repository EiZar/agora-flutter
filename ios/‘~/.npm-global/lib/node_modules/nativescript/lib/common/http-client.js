    ...
    httpRequestCore(options, proxySettings) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = new Promise((resolve, reject) => {
                let timerId;
                const cleanupRequestData = Object.create({
                    timers: [],
                });
                ...
                requestObj
                    ...
                    err.proxyAuthenticationRequired =
                        errorMessageStatusCode ===
                            constants_1.HttpStatusCodes.PROXY_AUTHENTICATION_REQUIRED;
                    ...
                    cleanupRequestData.stuckResponseIntervalId = setInterval(() => {
                        if (Date.now() - lastChunkTimestamp >
                    ...
                    const successful = helpers.isRequestSuccessful(responseData) ||
                        responseData.statusCode === constants_1.HttpStatusCodes.NOT_MODIFIED;
                    if (!successful) {
                        pipeTo = undefined;
                    }
