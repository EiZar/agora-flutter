...
class IOSDeviceFileSystem {
    ...
    listFiles(devicePath, appIdentifier) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let children = [];
            const result = yield this.$iosDeviceOperations.listDirectory([
    ...
    getFile(deviceFilePath, appIdentifier, outputFilePath) {
        return __awaiter(this, void 0, void 0, function* () {
            if (outputFilePath) {
                yield this.$iosDeviceOperations.downloadFiles([
                    {
                        appId: appIdentifier,
    ...
    getFileContent(deviceFilePath, appIdentifier) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.$iosDeviceOperations.readFiles([
                {
                    deviceId: this.device.deviceInfo.identifier,
                    path: deviceFilePath,
                    appId: appIdentifier,
    ...
    deleteFile(deviceFilePath, appIdentifier) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.$iosDeviceOperations.deleteFiles([
                {
                    appId: appIdentifier,
