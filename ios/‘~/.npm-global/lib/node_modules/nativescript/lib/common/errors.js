...
exports.Errors = exports.installUncaughtExceptionListener = void 0;
...
function resolveCallStack(error) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const fs = require("fs");
        const remapped = yield Promise.all(_.map(parsed, (parsedLine) => __awaiter(this, void 0, void 0, function* () {
            ...
            return yield source_map_1.SourceMapConsumer.with(mapData, null, (consumer) => {
...
function installUncaughtExceptionListener(actionOnException) {
    const handler = (err) => __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (callstack) {
                try {
                    callstack = yield resolveCallStack(err);
                }
                catch (err) {
            ...
            yield tryTrackException(err, yok_1.injector);
...
function tryTrackException(error, localInjector) {
    return __awaiter(this, void 0, void 0, function* () {
...
class Errors {
    ...
    beginCommand(action, printCommandHelpSuggestion) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield action();
            }
