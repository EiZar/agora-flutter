    ...
    deploy(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const executeAction = (device) => __awaiter(this, void 0, void 0, function* () {
                ...
                const prepareData = Object.assign(Object.assign({}, deviceDescriptor.buildData), { nativePrepare: {
                ...
                yield this.$deviceInstallAppService.installOnDevice(device, Object.assign(Object.assign({}, deviceDescriptor.buildData), { buildForDevice: !device.isEmulator }), packageFilePath);
            });
