...
class UpdateController extends update_controller_base_1.UpdateControllerBase {
    ...
    update(updateOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield this.getVersionFromTag(UpdateController.updatableDependencies[0].name, updateOptions.version);
            }
            catch (error) {
                this.$errors.fail(`${UpdateController.updateFailMessage} Reason is: ${error.message}`);
            }
    ...
    shouldUpdate({ projectDir, version, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((yield this.hasDependenciesToUpdate({
                dependencies,
                areDev: false,
                projectData,
            })) ||
                (yield this.hasDependenciesToUpdate({
            ...
            for (const platform in this.$devicePlatformsConstants) {
                ...
                if (yield this.shouldUpdateRuntimeVersion(constants_1.PackageVersion.LATEST, platformData.frameworkPackageName, platform, projectData)) {
                    return true;
                }
            }
        });
    ...
    cleanUpProject(projectData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (projectData.projectType === constants.ProjectTypes.ReactFlavorName ||
    ...
    updateProject(projectData, version) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.updateRuntimes(projectData);
    ...
    shouldUpdateDependency(dependency, targetVersion, projectData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (maxSatisfyingProjectVersion &&
    ...
    updateRuntimes(projectData) {
        return __awaiter(this, void 0, void 0, function* () {
            for (const platform in this.$devicePlatformsConstants) {
                const lowercasePlatform = platform.toLowerCase();
                const platformData = this.$platformsDataService.getPlatformData(lowercasePlatform, projectData);
                if (yield this.shouldUpdateRuntimeVersion(constants_1.PackageVersion.LATEST, platformData.frameworkPackageName, platform, projectData)) {
                    const version = yield this.$packageInstallationManager.getMaxSatisfyingVersionSafe(platformData.frameworkPackageName, constants_1.PackageVersion.LATEST);
                    this.$logger.info(`Updating ${platform} platform to version '${version}'.`);
                    yield this.$addPlatformService.setPlatformVersion(platformData, projectData, version);
                }
            }
        });
    }
    shouldUpdateRuntimeVersion(templateRuntimeVersion, frameworkPackageName, platform, projectData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const maxRuntimeVersion = yield this.getMaxRuntimeVersion({
                platform,
                projectData,
            });
            return (maxTemplateRuntimeVersion &&
                maxRuntimeVersion &&
    ...
    getUpdatableDependencies(dependencies) {
        ...
        UpdateController.updatableDependencies.forEach((updatableDependency) => {
            ...
            else if (updatableDependency.alias &&
    ...
    getTemplateManifest(projectData, version) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            version =
                version ||
                    (yield this.$packageInstallationManager.getLatestCompatibleVersionSafe(templateName));
            try {
