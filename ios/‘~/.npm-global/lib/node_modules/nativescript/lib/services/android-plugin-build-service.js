...
class AndroidPluginBuildService {
    ...
    getLatestRuntimeVersion() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.$packageManager.view(constants_1.SCOPED_ANDROID_RUNTIME_NAME, {
                    "dist-tags": true,
                });
    ...
    getGradleVersions(runtimeVersion) {
        return __awaiter(this, void 0, void 0, function* () {
            let runtimeGradleVersions = null;
            try {
                const output = yield this.$packageManager.view(`${constants_1.SCOPED_ANDROID_RUNTIME_NAME}@${runtimeVersion}`, { gradle: true });
