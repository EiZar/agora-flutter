...
exports.IOSEntitlementsService = void 0;
...
class IOSEntitlementsService {
    ...
    merge(projectData) {
        return __awaiter(this, void 0, void 0, function* () {
            const session = new plist_merge_patch_1.PlistSession({
                log: (txt) => this.$logger.trace("App.entitlements: " + txt),
            });
            ...
            if (session.patches && session.patches.length > 0) {
                ...
                this.$logger.trace("App.entitlements: Write to: " +
