...
class PluginsService {
    ...
    ensureAllDependenciesAreInstalled(projectData) {
        return __awaiter(this, void 0, void 0, function* () {
            let installedDependencies = this.$fs.exists(this.getNodeModulesPath(projectData.projectDir))
            ...
            if (this.$fs.exists(pathToPlatforms)) {
                ...
                _.each(contents, (file) => {
                    if (path.extname(file) === ".framework") {
                        dependenciesWithFrameworks.push(Object.assign(Object.assign({}, d), { frameworkName: path.basename(file), frameworkLocation: path.join(pathToPlatforms, file) }));
                    }
                });
            }
        });
