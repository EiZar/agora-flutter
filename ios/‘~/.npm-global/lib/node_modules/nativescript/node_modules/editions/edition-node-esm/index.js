 ...
 * @throws An error if the edition failed to load
 */
export function requireEdition(edition, opts) {
		...
		if (edition.engines.node === true) {
			...
			throw errtion({
				message:
					...
					stringify(edition.engines.node) +
					']',
 ...
 */
export function requireEditions(editions, opts) {
	// Check
 ...
 * @throws An error if a suitable edition was unable to be resolved.
 */
export function requirePackage(cwd, require, entry) {
